  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <Button variant="primary" size="sm" className="gap-2"><Plus className="h-4 w-4" />Nuevo documento</Button>
      </div>
      ...
      <div className="grid gap-3">
        ...
        {!isLoading && docs.length === 0 && (
          <div className="text-center py-16 text-slate-400"><FileText className="h-10 w-10 mx-auto mb-3 opacity-40" /><p>No se encontraron documentos</p></div>
        )}
      </div>
    </div>
  );
